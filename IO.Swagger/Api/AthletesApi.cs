...
namespace IO.Swagger.Api
{
    ...
    public interface IAthletesApi : IApiAccessor
    {
        ...
        ActivityStats GetStats (int? id, int? page = null, int? perPage = null);
        ...
        ApiResponse<ActivityStats> GetStatsWithHttpInfo (int? id, int? page = null, int? perPage = null);
        /// <summary>
        /// Update Athlete
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ActivityStats> GetStatsAsync (int? id, int? page = null, int? perPage = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ActivityStats>> GetStatsAsyncWithHttpInfo (int? id, int? page = null, int? perPage = null);
        /// <summary>
        /// Update Athlete
        /// </summary>
        /// <remarks>
    ...
    public partial class AthletesApi : IAthletesApi
    {
        ...
        /// <param name="perPage">Number of items per page. Defaults to 30. (optional, default to 30)</param>
        /// <returns>ActivityStats</returns>
        public ActivityStats GetStats (int? id, int? page = null, int? perPage = null)
        {
             ApiResponse<ActivityStats> localVarResponse = GetStatsWithHttpInfo(id, page, perPage);
             return localVarResponse.Data;
        }
        ...
        /// <param name="perPage">Number of items per page. Defaults to 30. (optional, default to 30)</param>
        /// <returns>ApiResponse of ActivityStats</returns>
        public ApiResponse< ActivityStats > GetStatsWithHttpInfo (int? id, int? page = null, int? perPage = null)
        {
        ...
        /// <param name="perPage">Number of items per page. Defaults to 30. (optional, default to 30)</param>
        /// <returns>Task of ActivityStats</returns>
        public async System.Threading.Tasks.Task<ActivityStats> GetStatsAsync (int? id, int? page = null, int? perPage = null)
        {
             ApiResponse<ActivityStats> localVarResponse = await GetStatsAsyncWithHttpInfo(id, page, perPage);
             return localVarResponse.Data;
        ...
        /// <param name="perPage">Number of items per page. Defaults to 30. (optional, default to 30)</param>
        /// <returns>Task of ApiResponse (ActivityStats)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ActivityStats>> GetStatsAsyncWithHttpInfo (int? id, int? page = null, int? perPage = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling AthletesApi->GetStats");
